	...
	updateSim() {
		...
		if(this.resources.population > 0) {
			...
			if(foodShortage > 0) {
				...
				this.resources.population += this.resources.population * (0.01/12 + (-foodShortage) * Math.max(0, (0.5/12) - this.resources.toxins));
			}
			...
			if(this.resources.toxins > 0.02) {
				toxinDeaths += 100000 * this.resources.toxins * 100;
